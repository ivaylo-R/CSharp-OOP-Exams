...
public class DraftManager
{
    ...
    public string RegisterHarvester(List<string> arguments)
    {
        ...
        return $"Successfully registered {type}Harvester";
    }
    ...
    public string RegisterProvider(List<string> arguments)
    {
        ...
        return $"Successfully registered {type}Provider";
    }
    ...
    public string Day()
    {
        ...
        this.energyRepository.StoreEnergy(producedPower);
        ...
        sb.AppendLine($"Produced {totalMinedOre} ore today!");
    ...
    public string Mode(List<string> arguments)
    {
        ...
        return $"Mode changed to {this.mode}!.";
    }
    ...
    public string ShutDown()
    {
        ...
        sb.AppendLine($"Total Energy Stored: {this.energyRepository.EnergyStored}");
