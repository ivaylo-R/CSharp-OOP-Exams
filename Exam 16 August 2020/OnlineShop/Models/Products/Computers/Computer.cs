...
namespace OnlineShop.Models.Products.Computers
{
    public abstract class Computer : Product, IComputer
    {
        ...
        public override decimal Price
        {
            protected set
            {
                base.Price += GetToTalSumOfAllComponentsAndPeripherals();
            }
        }

        private decimal GetToTalSumOfAllComponentsAndPeripherals()
        {
            decimal sumOfAllComponentsPrice = this.Components.Sum(c => c.Price);
            decimal sumOfAllPeripheralsPrice = this.Peripherals.Sum(p => p.Price);
            return sumOfAllComponentsPrice + sumOfAllPeripheralsPrice;
        }
